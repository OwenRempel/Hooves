...
$DB = new DB('Hoves$2$RempelCattleCo$eb1eece2d1c37dbe');
$i = 0;
while($i < 100){
    ...
    echo "$Tag -- $ID\n";
    $DB->query("INSERT INTO Cattle (Tag, StartDate, HerdsMan, Investor, Price, AgeState, PenDate, Pen, Description, ID) VALUES ('$Tag', '$buyDate', '$invest', '$owner', '$price', '$type', '$penDate', '$pen', '$desc', '$ID')");
    $i++;
}
