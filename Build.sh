docker run -it -p "8080:80" --name "HovesAPI" -v ${PWD}/API/app:/app  -v ${PWD}/API/mysql:/var/lib/mysql -v ${PWD}/API/logs:/var/log/apache2 -e CREATE_MYSQL_BASIC_USER_AND_DB=true -e MYSQL_USER_NAME='HovesAdmin' \
 -e MYSQL_USER_DB='*' \
